...
namespace Interfaces
{
    ...
    public interface IQuestStep {
        ...
        bool AddPlayerToQuest(ObjectId playerID);
    }
    ...
    //    public Dictionary<ObjectId, int> CurrentPlayerStep { get; set; }
