...
namespace Calendar {
	public static class Calendar {
        //TODO: map these bsondocument to classes
		...
		public static BsonDocument UpdateTimeOfDay(BsonDocument time) {
			...
			if (Enum.IsDefined(typeof(DayNight), dayTicks) && oldTime != ((DayNight)dayTicks).ToString()) {
				time["TimeOfDay"] = ((DayNight)dayTicks).ToString();
                    ...
                    IRoom room = null;
                //Todo: maybe notify NPC's in the future as well or at least let them subscribe to this so they can trigger on something, like vampires waking up at dusk and going to sleeping in the morning
