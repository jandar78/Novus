...
namespace Interfaces {
	...
	public interface IIluminate {
		...
		void Drain();
		IMessage Ignite(); //the commands will call these, but at command level the action has to be specific to the fuel source (ignite, activate, turn on, etc)
		IMessage Extinguish(); //same deal as Ignite
