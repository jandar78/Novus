...
namespace AI {
    ...
    //Todo: look into maybe replacing this with a more scripted AI type like BehaviorTree rather than using a simple FSM to allow more complex behavior
    public class FSM : IFsm {
        ...
        public void InterpretMessage(IMessage message, IActor actor) {
            ...
            MessageParser parser = new MessageParser(message, actor, npc.Triggers.ToList<ITrigger>());
