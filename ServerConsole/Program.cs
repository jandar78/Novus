...
namespace ServerConsole
{
    public class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            {
                Console.WriteLine("Settings.cfg file not found in " + Directory.GetCurrentDirectory() + ".  Server shutting down.");
                return;
            }
            ...
            try
            {
                ...
                while (true)
                {
                    ...
                    try
                    {
                        ...
                        if (Sockets.Server.GetCurrentUserList().Count > 0)
                        {
                            ...
                            foreach (IUser user in Sockets.Server.GetCurrentUserList())
                            {
                                ...
                                //Players signing in to their character
                    ...
                    catch (Exception ex)
                    {
                        ...
                        temp.UserID = new MongoDB.Bson.ObjectId();
                ...
                Console.WriteLine("Server succesfully SHUTDOWN");
            }
